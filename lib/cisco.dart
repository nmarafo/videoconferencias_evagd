          ...
          Positioned.fill(
            child: GestureDetector(
              child: Column(
                ...
                children: [
                  const Text('Pulse para navegar al lugar de la videoconferencia (Cisco Webex)',style: TextStyle(fontWeight: FontWeight.bold),),
              ...
              onTap: (){
                _launchURL('https://www.gobiernodecanarias.net/aplicaciones/sirvete/principal/');
              },
            ),
